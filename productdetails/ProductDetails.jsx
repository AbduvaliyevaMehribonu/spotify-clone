...
// https://mold-components.onrender.com/order/delete-single-order/(orderIDsi)
// yuqoridagi api admin qismidagi orderlarni o'chirish uchun
  ...
  return (
    <div className="product-details">
      <div className="product-details__images">
        <img alt='img' className="product-details--images" src={productDetailsData?.productImages[activeImagesNumber]} />
        <div className="product-details__images">
          {
